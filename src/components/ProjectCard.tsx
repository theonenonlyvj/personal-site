    ...
    >
      {imgOk ? (
        <img
          ...
          style={{ width: '100%', aspectRatio: '16 / 10', objectFit: project.thumbFit ?? 'cover', objectPosition: project.thumbPosition ?? 'center', background: project.thumbFit === 'contain' ? '#ffffff' : 'var(--hair-2)' }}
        />
      ) : (
        <div
          role="img"
